...
// Type definitions for new items
interface NewTask {
...
interface JobPlanFormContentProps {
...
/**
 * Job Plan Form Content Component
 * Reusable form content for creating and editing job plans.
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                      ...
                      <Card key={index}>
                        <CardContent className="pt-6 space-y-3">
                          ...
                          <Textarea
                            ...
                            onChange={(e) => {
                              const newTools = [...tools];
                              newTools[index].tool_description = e.target.value;
                              setTools(newTools);
                            }}
                          />
                        </CardContent>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-muted-foreground">{form.watch("title") || "N/A"}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium">Job Type:</p>
                      <p className="text-muted-foreground capitalize">{form.watch("job_type")}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium">Tasks:</p>
                      <p className="text-muted-foreground">{tasks.length} task(s) defined</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium">Parts:</p>
                      <p className="text-muted-foreground">{parts.length} part(s) required</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium">Tools:</p>
                      <p className="text-muted-foreground">{tools.length} tool(s) required</p>
                    </div>
                  </CardContent>
                </Card>
              </TabsContent>
            ...
            <div className="flex justify-end gap-3 pt-6 border-t">
              <Button
                type="submit"
                disabled={createJobPlan.isPending || updateJobPlan.isPending}
              >
                <Save className="w-4 h-4 mr-2" />
                {mode === "edit" ? "Update Job Plan" : "Create Job Plan"}
              </Button>
            </div>
          </form>
        </Form>
